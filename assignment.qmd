...
I stored the data table with the total votes column. I then grouped the data based on county and precinct so all of the votes within each precinct and county would be combined. I then filtered for the results of the governor's race and used the sum function to count the number of votes cast within each group, aka precinct.
```{r}
